        ...
        <v-container grid-list-lg>
            <v-layout row wrap>
                ...
                <router-link
                    ...
                    ><v-card-media
                        :src="product.imageSrc"
                        height="350px"></v-card-media></router-link>
                    <v-card>
                        ...
                        <v-card-title primary-title>
                            ...
                            <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn dark color="blue" round outline :to="'/product/' + product.id">Description</v-btn>
                                <v-btn dark color="dark-blue" round>Add to Cart</v-btn>
                            </v-card-actions>
                        </v-card-title>
                    </v-card>
                </v-flex>
            ...
            products: [
                {
                    ...
                    vendor: 'Lenovo',
                    color: 'black',
                    materical: 'metal/plastic',
                    description: 'Intel Core i5 7300HQ 2500 MHz/15.6"/1920x1080/8Gb/1000Gb HDD/DVD нет/NVIDIA GeForce GTX 1050, 4096 ћЅ/Wi-Fi/Bluetooth/Win 10 Home',
                    price: 784,
                    promo: false,
                ...
                },
                {
                    ...
                    color: 'black',
                    materical: 'metal/plastic',
                    description: 'Intel Core i7 8750H 2300 MHz/15.6"/1920x1080/12Gb/1000Gb HDD/DVD нет/NVIDIA GeForce GTX 1050, 4096 ћЅ/Wi-Fi/Bluetooth/Win 10 Home',
                    price: 1220,
                    promo: true,
